 ...
 * specified in, but are not intended to add elements to the DOM as are {@link angular.widget widgets}.
 * 
 ...
 *     {@link guide/dev_guide.expressions expression} that on the current scope evaluates to a constructor
 *     function.
 *
 * @example
 ...
 *
 * @description
 * The `ng:bind-attr` attribute specifies that {@link guide/dev_guide.templates.databinding databindings}  should be
 ...
 *
 * @element ANY
 * @param {expression} expression {@link guide/dev_guide.expressions Expression} to eval. Must be inside
 * `ng:repeat`.
 *
 * @example
   <doc:example>
 ...
 *
 * @element ANY
 * @param {expression} expression If the {@link guide/dev_guide.expressions expression} is truthy then the element
 ...
 *
 * @element ANY
 * @param {expression} expression If the {@link guide/dev_guide.expressions expression} truthy then the element
 *     is shown or hidden respectively.
 *
 * @example
   <doc:example>
 ...
 *
 * @element ANY
 * @param {expression} expression {@link guide/dev_guide.expressions Expression} which evals to an object whose
